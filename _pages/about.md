...
I am broadly interested in computational methods for the analysis of diverse transport phenomena, including methods for simulation, data analysis, and Uncertainty Quantification (UQ) of systems ranging from liquid rockets to the space weather-driving solar atmosphere. In particular, I’m excited to be working on multifidelity Bayesian parameter inference for space radiation transport as a part of the [Center for Advancing the Radiation Resilience of Electronics](https://carre-psaapiv.org/).
